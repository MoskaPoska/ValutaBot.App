    ...
    public static string GetCssStyles()
    {
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; -webkit-tap-highlight-color: transparent; }
        ...
        @keyframes glitchBg {
            ...
            50% { opacity: 1; transform: translate(-1px, -1px) scale(1.02); }
        ...
        .radar-grid path, .radar-grid line {
            fill: none;
        ...
        .radar-poly.trend { fill: rgba(16,185,129,0.3); stroke: #10b981; filter: drop-shadow(0 0 10px rgba(16,185,129,0.6)); }
        .radar-poly.flat { fill: rgba(139,92,246,0.3); stroke: #8b5cf6; filter: drop-shadow(0 0 10px rgba(139,92,246,0.6)); }
        .radar-poly.chaos { fill: rgba(245,158,11,0.3); stroke: #f59e0b; filter: drop-shadow(0 0 10px rgba(245,158,11,0.6)); }
